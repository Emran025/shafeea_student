...
final class AppConfig {
  ...
  /// Used as the application display name prefix and APK identifier.
  /// Empty string in General Mode.
  ...
  /// In this mode, [appKey] is injected into every API request header.
  static bool get isSchoolLocked => appKey.isNotEmpty;

  /// True in General Mode — the app can serve any school.
  /// All existing multi-school logic remains fully active.
